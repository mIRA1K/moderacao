...
module.exports = async ({ guild }, user) => {
  ...
  const embed = new MessageEmbed()
    ...
    .addField("Registrado no Discord", user.createdAt.toDateString(), false)
    ...
    .addField("Reputação", `${userData.reputation.received}`, true)
    ...
    .setFooter("Campos marcados (*) são específicos do servidor");
